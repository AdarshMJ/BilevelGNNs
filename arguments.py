...
def parse_args():
    ...
    parser.add_argument('--inner_iterations', type=int, default=10, help='Number of inner iterations')
    ...
    #parser.add_argument('--model1', type=str, default='GCN', choices=['GCN', 'GATv2','SimpleGCN','MLP'], help='Model to use')
   # parser.add_argument('--model2', type=str, default='MLP', choices=['GCN', 'GATv2','SimpleGCN','MLP'], help='Model to use')
